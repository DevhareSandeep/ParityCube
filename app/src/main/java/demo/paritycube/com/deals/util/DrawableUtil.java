...
public final class DrawableUtil
{
  ...
  public static Drawable createDrawable (Context context, @DrawableRes int drawableResID,
      int maskColor)
  {
    Drawable disableDrawable = ViewHelper.getDrawable(context, drawableResID);
    disableDrawable.setAlpha(77);

    Drawable pressedDrawable = ViewHelper.getDrawable(context, drawableResID);
    pressedDrawable.mutate();
    pressedDrawable.setColorFilter(maskColor, PorterDuff.Mode.MULTIPLY);

    Drawable normalColor = ViewHelper.getDrawable(context, drawableResID);
